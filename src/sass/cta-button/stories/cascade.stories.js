...
<a class="cta-btn" href="http://www.ebay.com" style="color: red">
    <span class="cta-btn__cell">
        <span>Link</span>
        <svg class="icon icon--arrow-right-24" height="8" width="8" aria-hidden="true">
...
<div dir="rtl">
    <a class="cta-btn" href="http://www.ebay.com" style="color: red">
        <span class="cta-btn__cell">
            ...
            <svg style="margin-right: 5px; margin-left: 2px;" class="icon icon--arrow-right-24" height="8" width="8" aria-hidden="true">
                <use href="#icon-arrow-right-24"></use>
            </svg>
        </span>
    </a>
