export default { title: 'Filter/Menu Button' };
        ...
        <div class="filter-menu-button__items" role="menu">
            <div class="filter-menu-button__item" role="menuitemcheckbox" aria-checked="false">
                <span class="filter-menu-button__checkbox">
                    <svg class="icon icon--web-checkbox-unselected-18" focusable="false" height="18" width="18">
                        <use href="#icon-web-checkbox-unselected-18"></use>
                    </svg>
                    <svg class="icon icon--web-checkbox-selected-18" focusable="false" height="18" width="18">
