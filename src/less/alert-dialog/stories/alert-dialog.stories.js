...
export const base = () => `
<div aria-labelledby="alert-dialog-alert-title" aria-modal="true" class="alert-dialog alert-dialog--mask-fade" role="alertdialog">
    <div class="alert-dialog__window alert-dialog__window--fade">
        <div class="alert-dialog__header">
            <h2 id="alert-dialog-title" class="alert_dialog__title">Alert!</h2>
        </div>
