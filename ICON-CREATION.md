...
>![copy layer](./svg-icon-docs-screenshots/copy-layer.png)
...
>![reset coordinates](./svg-icon-docs-screenshots/reset-coordinates.png)

## Step 2: Process the SVG source code

- Right click the icon's symbol layer and `Detach from symbol`

>![detach from symbol](./svg-icon-docs-screenshots/detach-from-symbol.png)

- Open the icon folder and `Copy SVG code` from the icon layer (**DO NOT** copy the SVG from the folder)

>![copy svg code](./svg-icon-docs-screenshots/copy-svg-code-layer-highlighted.png)
>![copy svg code](./svg-icon-docs-screenshots/copy-svg-code.png)
...
>![paste SVG code into SVGOMG](./svg-icon-docs-screenshots/svgomg-paste-markup.png)

## Step 3: Create the symbol in the SVG definition

- Copy the `<path>` from SVGOMG (see examples below)

![svgomg ouput](./svg-icon-docs-screenshots/svgomg-copy-output.png)
...
>![symbol definition file](./svg-icon-docs-screenshots/svg-symbols-file.png)
