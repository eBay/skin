...
nodeListToArray(document.querySelectorAll('.btn:not([aria-disabled="true"]):not(.dialog-button):not(.tooltip-button):not(.tool-button):not(.tourtip--link-callout)')).forEach(function(el, i) {
