...
$_mod.installed("@ebay/skin$3.4.0","makeup-expander","0.3.0");
...
$_mod.installed("@ebay/skin$3.4.0","makeup-roving-tabindex","0.0.3");
...
$_mod.installed("@ebay/skin$3.4.0","makeup-key-emitter","0.0.2");
$_mod.installed("@ebay/skin$3.4.0","makeup-prevent-scroll-keys","0.0.1");
...
$_mod.def("/@ebay/skin$3.4.0/docs/src/js/ds6/main", function(require, exports, module, __filename, __dirname) { // Most of this is code for the menu and listbox logic, which will be abstracted away into their own modules at some point
...
$_mod.run("/@ebay/skin$3.4.0/docs/src/js/ds6/main");