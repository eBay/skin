...
$_mod.installed("@ebay/skin$6.0.0", "makeup-expander", "0.4.0");
...
$_mod.installed("@ebay/skin$6.0.0", "makeup-floating-label", "0.0.2");
...
$_mod.installed("@ebay/skin$6.0.0", "makeup-roving-tabindex", "0.0.5");
...
$_mod.installed("@ebay/skin$6.0.0", "makeup-key-emitter", "0.0.3");
$_mod.installed("@ebay/skin$6.0.0", "makeup-prevent-scroll-keys", "0.0.2");
...
$_mod.installed("@ebay/skin$6.0.0", "makeup-modal", "0.0.4");
...
$_mod.def("/@ebay/skin$6.0.0/docs/src/js/ds6/transition", function(require, exports, module, __filename, __dirname) { /**
...
$_mod.def("/@ebay/skin$6.0.0/docs/src/js/ds6/main", function(require, exports, module, __filename, __dirname) { // Most of this is code for the menu and combobox logic, which will be abstracted away into their own modules at some point
...
var transition = require('/@ebay/skin$6.0.0/docs/src/js/ds6/transition'/*"./transition"*/);
...
$_mod.run("/@ebay/skin$6.0.0/docs/src/js/ds6/main");