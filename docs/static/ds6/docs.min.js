...
$_mod.def("/@ebay/skin$7.0.0-5/docs/src/js/base/main",function(e,t,o,n,r){var a=e("/makeup-modal$0.0.4/index"),i=e("/@ebay/skin$7.0.0-5/docs/src/js/base/transition"),l=e("/makeup-roving-tabindex$0.1.0/index"),c=e("/makeup-expander$0.6.0/index"),d=e("/makeup-floating-label$0.0.2/index"),u=e("/makeup-prevent-scroll-keys$0.0.2/index");querySelectorAllToArray(".expand-btn-example").forEach(function(e,t){e.addEventListener("click",function(e){var t="true"===this.getAttribute("aria-expanded");this.setAttribute("aria-expanded",!t)})}),querySelectorAllToArray(".listbox, .menu").forEach(function(e,t){if(e.querySelector(".expand-btn")){var o=(new c(e,{collapseOnFocusOut:!0,collapseOnMouseOut:!0,contentSelector:"[role=listbox], [role=menu]",expandOnClick:!0,focusManagement:"focusable",hostSelector:".expand-btn"}),e.querySelector("[role=menu], [role=listbox]"));l.createLinear(o,".listbox__option, .menu__item");querySelectorAllToArray(".listbox__option, .menu__item",o).forEach(function(e){u.add(e)})}}),querySelectorAllToArray(".fake-menu").forEach(function(e){new c(e,{collapseOnFocusOut:!0,collapseOnMouseOut:!0,contentSelector:".fake-menu__items",expandOnClick:!0,hostSelector:".expand-btn"})}),querySelectorAllToArray(".combobox").forEach(function(e){var t=e.querySelector("input");t.addEventListener("focus",function(o){var n="true"===t.getAttribute("aria-expanded");n?e.classList.remove("combobox--expanded"):e.classList.add("combobox--expanded"),t.setAttribute("aria-expanded",!n)}),t.addEventListener("blur",function(o){t.setAttribute("aria-expanded","false"),e.classList.remove("combobox--expanded")})}),querySelectorAllToArray(".dialog-button").forEach(function(e){function t(){r&&r(),r=i(l,"dialog--show",n(!0)),l.removeAttribute("hidden"),e.removeEventListener("click",t),l.addEventListener("click",o,!0),document.body.setAttribute("style","overflow:hidden"),a.modal(l.querySelector(".dialog__window"))}function o(d){c.contains(d.target)||(r&&r(),r=i(l,"dialog--hide",n(!1)),l.setAttribute("hidden",""),e.addEventListener("click",t),l.removeEventListener("click",o,!0),document.body.removeAttribute("style"),a.unmodal(),e.focus())}function n(e){e&&window.setTimeout(function(){d.focus()},250),r=void 0}var r,l=e.nextElementSibling,c=l.querySelector(".dialog__body"),d=l.querySelector(".dialog__close");e.addEventListener("click",t)}),querySelectorAllToArray(".tooltip").forEach(function(e){new c(e,{contentSelector:".tooltip__overlay",collapseOnFocusOut:!0,collapseOnMouseOut:!0,expandOnFocus:!0,expandOnHover:!0,focusManagement:"focusable",hostSelector:".tooltip__host"})}),querySelectorAllToArray(".infotip").forEach(function(e){new c(e,{contentSelector:".infotip__overlay",expandOnFocus:!1,expandOnClick:!0,hostSelector:".infotip__host"})}),querySelectorAllToArray(".floating-label").forEach(function(e){new d(e)}),querySelectorAllToArray(".tabs").forEach(function(e){var t=(l.createLinear(e,".tabs__item",{wrap:!0}),querySelectorAllToArray(".tabs__item",e)),o=querySelectorAllToArray(".tabs__panel",e);e.addEventListener("rovingTabindexChange",function(e){t[e.detail.fromIndex].setAttribute("aria-selected","false"),t[e.detail.toIndex].setAttribute("aria-selected","true"),o[e.detail.fromIndex].hidden=!0,o[e.detail.toIndex].hidden=!1})})});
