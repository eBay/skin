...
$_mod.installed("@ebay/skin$7.0.0-5","makeup-active-descendant","0.0.4");
$_mod.main("/makeup-active-descendant$0.0.4","");
...
$_mod.def("/makeup-navigation-emitter$0.1.1/util",function(t,e,r,i,o){"use strict";function n(t){return Array.prototype.slice.call(t)}r.exports={nodeListToArray:n}});
...
$_mod.def("/makeup-navigation-emitter$0.1.1/index",function(t,e,n,i,o){"use strict";function s(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function r(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function a(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function u(t){t.forEach(function(t,e){t.setAttribute(w,e)})}function d(){this.atStart()?this.options.wrap&&(this.index=this.items.length-1):this.index--}function h(){this.atEnd()?this.options.wrap&&(this.index=0):this.index++}function c(t){for(var e=t.target,n=e.dataset.makeupIndex;"body"!==e.tagName.toLowerCase()&&!n;)e=e.parentNode,n=e.dataset.makeupIndex;void 0!==n&&(this.index=n)}function l(){this.index=0}function f(){this.index=this.items.length}function p(){null!==this.options.autoReset&&(this._index=this.options.autoReset,this._el.dispatchEvent(new CustomEvent("navigationModelReset",{detail:{toIndex:this.options.autoReset},bubbles:!1})))}function v(){this.items=_.nodeListToArray(this._el.querySelectorAll(this._itemSelector)),u(this.items),this._el.dispatchEvent(new CustomEvent("navigationModelMutation"))}var y=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),b=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i])}return t},_=t("/makeup-navigation-emitter$0.1.1/util"),x=t("/makeup-key-emitter$0.0.3/index"),m=t("/makeup-exit-emitter$0.0.4/index"),w="data-makeup-index",E={autoInit:0,autoReset:null,wrap:!1},L=function t(e,n,i){a(this,t),this.options=b({},E,i),this._el=e,this._itemSelector=n,this.items=_.nodeListToArray(e.querySelectorAll(n))},k=function(t){function e(t,n,i){a(this,e);var o=s(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n,i));return null!==o.options.autoInit&&(o._index=o.options.autoInit,o._el.dispatchEvent(new CustomEvent("navigationModelInit",{detail:{toIndex:o.options.autoInit},bubbles:!1}))),o}return r(e,t),y(e,[{key:"atEnd",value:function(){return this.index===this.items.length-1}},{key:"atStart",value:function(){return this.index<=0}},{key:"index",get:function(){return this._index},set:function(t){t!==this.index&&(this._el.dispatchEvent(new CustomEvent("navigationModelChange",{detail:{toIndex:t,fromIndex:this.index},bubbles:!1})),this._index=t)}}]),e}(L),g=function(){function t(e,n){a(this,t),this.model=n,this._keyPrevListener=d.bind(n),this._keyNextListener=h.bind(n),this._keyHomeListener=l.bind(n),this._keyEndListener=f.bind(n),this._clickListener=c.bind(n),this._focusExitListener=p.bind(n),this._observer=new MutationObserver(v.bind(n)),u(n.items),x.addKeyDown(e),m.addFocusExit(e),e.addEventListener("arrowLeftKeyDown",this._keyPrevListener),e.addEventListener("arrowRightKeyDown",this._keyNextListener),e.addEventListener("arrowUpKeyDown",this._keyPrevListener),e.addEventListener("arrowDownKeyDown",this._keyNextListener),e.addEventListener("homeKeyDown",this._keyHomeListener),e.addEventListener("endKeyDown",this._keyEndListener),e.addEventListener("click",this._clickListener),e.addEventListener("focusExit",this._focusExitListener),this._observer.observe(e,{childList:!0,subtree:!0})}return y(t,null,[{key:"createLinear",value:function(e,n,i){return new t(e,new k(e,n,i))}}]),t}();n.exports=g});
$_mod.installed("makeup-active-descendant$0.0.4","makeup-next-id","0.0.2");
$_mod.def("/makeup-active-descendant$0.0.4/util",function(t,e,r,n,o){"use strict";function c(t){return Array.prototype.slice.call(t)}r.exports={nodeListToArray:c}});
$_mod.def("/makeup-active-descendant$0.0.4/index",function(t,e,n,i,a){"use strict";function o(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function s(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function c(){var t=this._navigationEmitter.model.index;this._items=p.nodeListToArray(this._el.querySelectorAll(this._itemSelector)),this._items.forEach(function(e,n){n!==t?e.classList.remove(this._options.activeDescendantClassName):e.classList.add(this._options.activeDescendantClassName)})}function u(t){var e=this._items[t.detail.fromIndex],n=this._items[t.detail.toIndex];e&&e.classList.remove(this._options.activeDescendantClassName),n&&(n.classList.add(this._options.activeDescendantClassName),this._focusEl.setAttribute("aria-activedescendant",n.id)),this._el.dispatchEvent(new CustomEvent("activeDescendantChange",{detail:{fromIndex:t.detail.fromIndex,toIndex:t.detail.toIndex}}))}function d(){var t=this._options.activeDescendantClassName;this._items.forEach(function(e){e.classList.remove(t)}),this._focusEl.removeAttribute("aria-activedescendant")}function l(t,e,n,i,a){return new y(t,e,n,i,a)}var f=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i])}return t},h=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}(),v=t("/makeup-navigation-emitter$0.1.1/index"),_=t("/makeup-next-id$0.0.2/index"),p=t("/makeup-active-descendant$0.0.4/util"),m={activeDescendantClassName:"active-descendant"},b=function t(e){r(this,t),this._el=e,this._onMutationListener=c.bind(this),this._onChangeListener=u.bind(this),this._onResetListener=d.bind(this),e.addEventListener("navigationModelMutation",this._onMutationListener),e.addEventListener("navigationModelChange",this._onChangeListener),e.addEventListener("navigationModelReset",this._onResetListener)},y=function(t){function e(t,n,i,a,s){r(this,e);var c=o(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t));return c._options=f({},m,s),c._navigationEmitter=v.createLinear(t,a,{autoInit:-1,autoReset:-1}),c._focusEl=n,c._ownedEl=i,c._itemSelector=a,_(i),n.setAttribute("aria-owns",i.id),c._items=p.nodeListToArray(i.querySelectorAll(a)),c._items.forEach(function(t){_(t)}),c}return s(e,t),h(e,[{key:"wrap",set:function(t){this._navigationEmitter.model.options.wrap=t}}]),e}(b);n.exports={createLinear:l}});
$_mod.def("/@ebay/skin$7.0.0-5/docs/src/js/base/main",function(e,o,t,n,r){var l=e("/makeup-modal$0.0.4/index"),a=e("/@ebay/skin$7.0.0-5/docs/src/js/base/transition"),c=e("/makeup-roving-tabindex$0.1.0/index"),i=e("/makeup-expander$0.6.0/index"),u=e("/makeup-floating-label$0.0.2/index"),d=e("/makeup-prevent-scroll-keys$0.0.2/index"),s=e("/makeup-active-descendant$0.0.4/index");querySelectorAllToArray(".expand-btn-example").forEach(function(e,o){e.addEventListener("click",function(e){var o="true"===this.getAttribute("aria-expanded");this.setAttribute("aria-expanded",!o)})}),querySelectorAllToArray(".menu").forEach(function(e,o){if(e.querySelector(".expand-btn")){var t=(new i(e,{collapseOnFocusOut:!0,collapseOnMouseOut:!0,contentSelector:"[role=menu]",expandOnClick:!0,focusManagement:"focusable",hostSelector:".expand-btn"}),e.querySelector("[role=menu]"));c.createLinear(t,".menu__item");querySelectorAllToArray(".menu__item",t).forEach(function(e){d.add(e)})}}),querySelectorAllToArray(".fake-menu").forEach(function(e){new i(e,{collapseOnFocusOut:!0,collapseOnMouseOut:!0,contentSelector:".fake-menu__items",expandOnClick:!0,hostSelector:".expand-btn"})}),querySelectorAllToArray(".combobox").forEach(function(e){var o=(new i(e,{collapseOnFocusOut:!0,contentSelector:"[role=listbox]",expandedClass:"combobox--expanded",expandOnFocus:!0,hostSelector:"input"}),e.querySelector("input")),t=e.querySelector("[role=listbox]");s.createLinear(e,o,t,"[role=option]",{activeDescendantClassName:"combobox__option--active"})}),querySelectorAllToArray(".listbox").forEach(function(e){var o=(new i(e,{collapseOnFocusOut:!0,contentSelector:"[role=listbox]",expandedClass:"listbox--expanded",expandOnClick:!0,focusManagement:"content",hostSelector:"button"}),e.querySelector("button")),t=e.querySelector("[role=listbox]");s.createLinear(e,o,t,"[role=option]",{activeDescendantClassName:"listbox__option--active"});d.add(e.querySelector("[role=listbox]"))}),querySelectorAllToArray(".dialog-button").forEach(function(e){function o(){r&&r(),r=a(c,"dialog--show",n(!0)),c.removeAttribute("hidden"),e.removeEventListener("click",o),c.addEventListener("click",t,!0),document.body.setAttribute("style","overflow:hidden"),l.modal(c.querySelector(".dialog__window"))}function t(u){i.contains(u.target)||(r&&r(),r=a(c,"dialog--hide",n(!1)),c.setAttribute("hidden",""),e.addEventListener("click",o),c.removeEventListener("click",t,!0),document.body.removeAttribute("style"),l.unmodal(),e.focus())}function n(e){e&&window.setTimeout(function(){u.focus()},250),r=void 0}var r,c=e.nextElementSibling,i=c.querySelector(".dialog__body"),u=c.querySelector(".dialog__close");e.addEventListener("click",o)}),querySelectorAllToArray(".tooltip").forEach(function(e){new i(e,{contentSelector:".tooltip__overlay",collapseOnFocusOut:!0,collapseOnMouseOut:!0,expandOnFocus:!0,expandOnHover:!0,focusManagement:"focusable",hostSelector:".tooltip__host"})}),querySelectorAllToArray(".infotip").forEach(function(e){new i(e,{contentSelector:".infotip__overlay",expandOnFocus:!1,expandOnClick:!0,hostSelector:".infotip__host"})}),querySelectorAllToArray(".floating-label").forEach(function(e){new u(e)}),querySelectorAllToArray(".tabs").forEach(function(e){var o=(c.createLinear(e,"[role=tab]",{wrap:!0}),querySelectorAllToArray("[role=tab]",e)),t=querySelectorAllToArray("[role=tabpanel]",e);e.addEventListener("rovingTabindexChange",function(e){o[e.detail.fromIndex].setAttribute("aria-selected","false"),o[e.detail.toIndex].setAttribute("aria-selected","true"),t[e.detail.fromIndex].hidden=!0,t[e.detail.toIndex].hidden=!1}),querySelectorAllToArray("[role=tab]",e).forEach(function(e){d.add(e)})})});
