...
$_mod.installed("@ebay/skin$7.0.0-5","makeup-expander","0.6.0");
$_mod.main("/makeup-expander$0.6.0","");
...
$_mod.installed("@ebay/skin$7.0.0-5","makeup-active-descendant","0.0.5");
$_mod.main("/makeup-active-descendant$0.0.5","");
...
$_mod.def("/makeup-active-descendant$0.0.5/util",function(t,e,r,n,o){"use strict";function c(t){return Array.prototype.slice.call(t)}r.exports={nodeListToArray:c}});
$_mod.def("/makeup-active-descendant$0.0.5/index",function(e,t,n,i,a){"use strict";function o(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function s(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function c(){var e=this._options,t=this._navigationEmitter.model.index;this._items=m.nodeListToArray(this._el.querySelectorAll(this._itemSelector)),this._items.forEach(function(n,i){i!==t?n.classList.remove(e.activeDescendantClassName):n.classList.add(e.activeDescendantClassName)})}function u(e){var t=this._items[e.detail.fromIndex],n=this._items[e.detail.toIndex];t&&t.classList.remove(this._options.activeDescendantClassName),n&&(n.classList.add(this._options.activeDescendantClassName),this._focusEl.setAttribute("aria-activedescendant",n.id)),this._el.dispatchEvent(new CustomEvent("activeDescendantChange",{detail:{fromIndex:e.detail.fromIndex,toIndex:e.detail.toIndex}}))}function d(){var e=this._options.activeDescendantClassName;this._items.forEach(function(t){t.classList.remove(e)}),this._focusEl.removeAttribute("aria-activedescendant")}function l(e,t,n,i,a){return new y(e,t,n,i,a)}var f=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}return e},h=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),v=e("/makeup-navigation-emitter$0.1.2/index"),_=e("/makeup-next-id$0.0.2/index"),m=e("/makeup-active-descendant$0.0.5/util"),p={activeDescendantClassName:"active-descendant"},b=function e(t){r(this,e),this._el=t,this._onMutationListener=c.bind(this),this._onChangeListener=u.bind(this),this._onResetListener=d.bind(this),t.addEventListener("navigationModelMutation",this._onMutationListener),t.addEventListener("navigationModelChange",this._onChangeListener),t.addEventListener("navigationModelReset",this._onResetListener)},y=function(e){function t(e,n,i,a,s){r(this,t);var c=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));return c._options=f({},p,s),c._navigationEmitter=v.createLinear(e,a,{autoInit:-1,autoReset:-1}),c._focusEl=n,c._ownedEl=i,c._itemSelector=a,_(i),n.setAttribute("aria-owns",i.id),c._items=m.nodeListToArray(i.querySelectorAll(a)),c._items.forEach(function(e){_(e)}),c}return s(t,e),h(t,[{key:"wrap",set:function(e){this._navigationEmitter.model.options.wrap=e}}]),t}(b);n.exports={createLinear:l}});
$_mod.def("/@ebay/skin$7.0.0-5/docs/src/js/base/main",function(e,t,o,n,r){var l=e("/makeup-modal$0.0.4/index"),a=e("/@ebay/skin$7.0.0-5/docs/src/js/base/transition"),c=e("/makeup-roving-tabindex$0.1.0/index"),i=e("/makeup-expander$0.6.0/index"),u=e("/makeup-floating-label$0.0.2/index"),d=e("/makeup-prevent-scroll-keys$0.0.2/index"),s=e("/makeup-active-descendant$0.0.5/index");querySelectorAllToArray(".expand-btn-example").forEach(function(e,t){e.addEventListener("click",function(e){var t="true"===this.getAttribute("aria-expanded");this.setAttribute("aria-expanded",!t)})}),querySelectorAllToArray(".menu").forEach(function(e,t){if(e.querySelector(".expand-btn")){var o=(new i(e,{autoCollapse:!0,contentSelector:"[role=menu]",expandOnClick:!0,focusManagement:"focusable",hostSelector:".expand-btn"}),e.querySelector("[role=menu]"));c.createLinear(o,".menu__item");querySelectorAllToArray(".menu__item",o).forEach(function(e){d.add(e)})}}),querySelectorAllToArray(".fake-menu").forEach(function(e){new i(e,{collapseOnFocusOut:!0,collapseOnMouseOut:!0,contentSelector:".fake-menu__items",expandOnClick:!0,hostSelector:".expand-btn"})}),querySelectorAllToArray(".combobox").forEach(function(e){var t=(new i(e,{autoCollapse:!0,contentSelector:"[role=listbox]",expandedClass:"combobox--expanded",expandOnFocus:!0,hostSelector:"input"}),e.querySelector("input")),o=e.querySelector("[role=listbox]");s.createLinear(e,t,o,"[role=option]",{activeDescendantClassName:"combobox__option--active"})}),querySelectorAllToArray(".listbox").forEach(function(e){var t=(new i(e,{autoCollapse:!0,contentSelector:"[role=listbox]",expandedClass:"listbox--expanded",expandOnClick:!0,focusManagement:"content",hostSelector:"button"}),e.querySelector("button")),o=e.querySelector("[role=listbox]");s.createLinear(e,t,o,"[role=option]",{activeDescendantClassName:"listbox__option--active"});d.add(e.querySelector("[role=listbox]"));querySelectorAllToArray("[role=option]",o),t.querySelector(".expand-btn__cell > span:first-child");e.addEventListener("activeDescendantChange",function(e){})}),querySelectorAllToArray(".dialog-button").forEach(function(e){function t(){r&&r(),r=a(c,"dialog--show",n(!0)),c.removeAttribute("hidden"),e.removeEventListener("click",t),c.addEventListener("click",o,!0),document.body.setAttribute("style","overflow:hidden"),l.modal(c.querySelector(".dialog__window"))}function o(u){i.contains(u.target)||(r&&r(),r=a(c,"dialog--hide",n(!1)),c.setAttribute("hidden",""),e.addEventListener("click",t),c.removeEventListener("click",o,!0),document.body.removeAttribute("style"),l.unmodal(),e.focus())}function n(e){e&&window.setTimeout(function(){u.focus()},250),r=void 0}var r,c=e.nextElementSibling,i=c.querySelector(".dialog__body"),u=c.querySelector(".dialog__close");e.addEventListener("click",t)}),querySelectorAllToArray(".tooltip").forEach(function(e){new i(e,{contentSelector:".tooltip__overlay",collapseOnFocusOut:!0,collapseOnMouseOut:!0,expandOnFocus:!0,expandOnHover:!0,focusManagement:"focusable",hostSelector:".tooltip__host"})}),querySelectorAllToArray(".infotip").forEach(function(e){var t=new i(e,{contentSelector:".infotip__overlay",expandOnFocus:!1,expandOnClick:!0,hostSelector:".infotip__host"});e.querySelector(".infotip__close").addEventListener("click",function(){t.collapse()})}),querySelectorAllToArray(".tourtip").forEach(function(e){e.querySelector(".tourtip__close").addEventListener("click",function(){e.classList.remove("tourtip--expanded")})}),querySelectorAllToArray(".floating-label").forEach(function(e){new u(e)}),querySelectorAllToArray(".tabs").forEach(function(e){var t=(c.createLinear(e,"[role=tab]",{wrap:!0}),querySelectorAllToArray("[role=tab]",e)),o=querySelectorAllToArray("[role=tabpanel]",e);e.addEventListener("rovingTabindexChange",function(e){t[e.detail.fromIndex].setAttribute("aria-selected","false"),t[e.detail.toIndex].setAttribute("aria-selected","true"),o[e.detail.fromIndex].hidden=!0,o[e.detail.toIndex].hidden=!1}),querySelectorAllToArray("[role=tab]",e).forEach(function(e){d.add(e)})})});
