...
$_mod.installed("@ebay/skin$7.0.0-4","makeup-modal","0.0.4");
...
$_mod.installed("@ebay/skin$7.0.0-4","makeup-expander","0.6.0");
...
$_mod.installed("@ebay/skin$7.0.0-4","makeup-floating-label","0.0.2");
...
$_mod.def("/@ebay/skin$7.0.0-4/docs/src/js/base/main",function(e,t,o,n,r){var a=e("/makeup-modal$0.0.4/index"),i=e("/@ebay/skin$7.0.0-4/docs/src/js/base/transition"),d=e("/makeup-roving-tabindex$0.1.0/index");querySelectorAllToArray(".expand-btn-example").forEach(function(e,t){e.addEventListener("click",function(e){var t="true"===this.getAttribute("aria-expanded");this.setAttribute("aria-expanded",!t)})}),querySelectorAllToArray(".listbox, .menu, .fake-menu").forEach(function(e,t){var o=e.querySelector("button");o&&(o.addEventListener("click",function(e){var t="true"===o.getAttribute("aria-expanded");o.setAttribute("aria-expanded",!t)}),o.addEventListener("blur",function(e){o.setAttribute("aria-expanded","false")}))}),querySelectorAllToArray(".combobox").forEach(function(e,t){var o=e.querySelector("input");o.addEventListener("focus",function(t){var n="true"===o.getAttribute("aria-expanded");n?e.classList.remove("combobox--expanded"):e.classList.add("combobox--expanded"),o.setAttribute("aria-expanded",!n)}),o.addEventListener("blur",function(t){o.setAttribute("aria-expanded","false"),e.classList.remove("combobox--expanded")})}),querySelectorAllToArray(".dialog-button").forEach(function(e){function t(){r&&r(),r=i(d,"dialog--show",n(!0)),d.removeAttribute("hidden"),e.removeEventListener("click",t),d.addEventListener("click",o,!0),document.body.setAttribute("style","overflow:hidden"),a.modal(d.querySelector(".dialog__window"))}function o(c){l.contains(c.target)||(r&&r(),r=i(d,"dialog--hide",n(!1)),d.setAttribute("hidden",""),e.addEventListener("click",t),d.removeEventListener("click",o,!0),document.body.removeAttribute("style"),a.unmodal(),e.focus())}function n(e){e&&window.setTimeout(function(){c.focus()},250),r=void 0}var r,d=e.nextElementSibling,l=d.querySelector(".dialog__body"),c=d.querySelector(".dialog__close");e.addEventListener("click",t)});var l=e("/makeup-expander$0.6.0/index");querySelectorAllToArray(".tooltip").forEach(function(e,t){new l(e,{contentSelector:".tooltip__overlay",collapseOnFocusOut:!0,collapseOnMouseOut:!0,expandOnFocus:!0,expandOnHover:!0,focusManagement:"focusable",hostSelector:".tooltip__host"})}),querySelectorAllToArray(".infotip").forEach(function(e,t){new l(e,{contentSelector:".infotip__overlay",expandOnFocus:!1,expandOnClick:!0,hostSelector:".infotip__host"})});var c=e("/makeup-floating-label$0.0.2/index");querySelectorAllToArray(".floating-label").forEach(function(e,t){new c(e)}),querySelectorAllToArray(".tabs").forEach(function(e,t){var o=(d.createLinear(e,".tabs__item",{wrap:!0}),querySelectorAllToArray(".tabs__item",e)),n=querySelectorAllToArray(".tabs__panel",e);e.addEventListener("rovingTabindexChange",function(e){o[e.detail.fromIndex].setAttribute("aria-selected","false"),o[e.detail.toIndex].setAttribute("aria-selected","true"),n[e.detail.fromIndex].hidden=!0,n[e.detail.toIndex].hidden=!1})})});
$_mod.run("/@ebay/skin$7.0.0-4/docs/src/js/base/main");
$_mod.def("/@ebay/skin$7.0.0-4/docs/src/js/ds6/main",function(i,e,d,n,o){function a(){var i=window.mm.matches,e=window.scrollY||window.pageYOffset;!i&&e>=window.sidebar_top?window.sidebar.classList.add("fixed"):window.sidebar.classList.remove("fixed")}window.mobileMediaQuery="all and (max-width: 600px)",window.mm=window.matchMedia(window.mobileMediaQuery),window.sidebar=document.querySelector("nav .fixed-nav"),window.sidebar_top=sidebar.offsetTop,window.addEventListener("resize",function(i,e,d){var n;return function(){var o=this,a=arguments,w=function(){n=null,d||i.apply(o,a)},t=d&&!n;clearTimeout(n),n=setTimeout(w,e),t&&i.apply(o,a)}}(function(){mm=window.matchMedia(mobileMediaQuery)},50)),window.addEventListener("load",function(){a(),window.addEventListener("scroll",a)})});
$_mod.run("/@ebay/skin$7.0.0-4/docs/src/js/ds6/main");